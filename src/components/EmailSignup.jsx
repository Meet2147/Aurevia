...
const EmailSignup = () => {
    return (
        <section
            id="email-signup"
            className="relative py-20 sm:py-24 md:py-28 lg:py-32 bg-gradient-to-br from-orange-500 via-red-500 to-amber-500 text-white overflow-hidden"
        >
            {/* Floating blobs */}
            ...
            <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
                ...
                >
                    ...
                    <p className="text-base sm:text-lg md:text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
                        ...
                        AI-powered outfit suggestions, personalized just for
                        you.
                    </p>
                </motion.div>

                {/* GetLaunchList Email Form */}
                <motion.form
                    className="launchlist-form max-w-xl mx-auto mb-10"
                    action="https://getlaunchlist.com/s/1xOHek"
                    method="POST"
